            ...
            ${showSearch ? `
                <div class="filter-section search-section">
                    <div class="search-inner">
                        ...
                        <input type="text" placeholder="${escapeHtmlAttribute(searchPlaceholder)}" class="search-input-pill" data-filter-bar-search value="${escapeHtmlAttribute(searchValue)}">
                    </div>
                </div>
            ` : ''}
