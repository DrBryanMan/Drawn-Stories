...
export function openEditPersonModal(person, onUpdate) {
    ...
    if (role === 'admin') {
        footerButtonsHTML = `
            <button type="button" class="btn-admin btn-admin--danger btn-delete-person-from-db">Видалити з бази</button>
        ...
        footerButtonsHTML = `
            <input type="text" id="edit-person-propose-comment" class="admin-input" placeholder="Коментар до вашої правки..." style="margin-right: auto; max-width: 260px; font-size: 12px; height: 32px; margin-bottom: 0;">
